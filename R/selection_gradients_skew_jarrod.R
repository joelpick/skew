...
if(re_run){
	...
	if(save & po_reg){
		...
		save(beta1,beta2, beta3, dmin, dmax, Wplot, Wplot.points, h2a, h2b, Eg_p, dEg_p, dz_p, dzn_p, S, Va, file=paste0(wd,"Data/Intermediate/", files_date), version=2)
	}
	if(save & !po_reg){
		save(beta1,beta2, beta3, dmin, dmax, Wplot, Wplot.points, h2a, h2b, S, Va, file=paste0(wd,"Data/Intermediate/", files), version=2)
		save(beta1,beta2, beta3, dmin, dmax, Wplot, Wplot.points, h2a, h2b, S, Va, file=paste0(wd,"Data/Intermediate/", files_date), version=2)
	}
