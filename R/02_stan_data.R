...
if(reduced){
	X <- model.matrix(~ year + timeC + sex + egg_weightC,THBW)

	X_noRep <- model.matrix(~ year + timeC + sex + egg_weightC,THBW_noRep)

}else{
	X <- model.matrix(~ male_present + clutch_sizeC + nest_hatch_dateC  + hatch_day + year + timeC + sex + egg_weightC,THBW)

	X_noRep <- model.matrix(~ male_present + clutch_sizeC + nest_hatch_dateC  + hatch_day + year + timeC + sex + egg_weightC,THBW_noRep)
}
